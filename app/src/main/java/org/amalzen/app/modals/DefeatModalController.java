...
public class DefeatModalController {
    @FXML
    private AnchorPane rootDefeatModalPane;
    @FXML
    ...
    public void handleBack() {
        ...
        AnchorPane parentPane = (AnchorPane) rootDefeatModalPane.getParent();
        if (parentPane != null) {
    ...
    public void initialize() {
        ...
        defeatLabel.setFont(gloockFont);
